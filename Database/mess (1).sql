...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2022 at 04:44 PM
...
INSERT INTO `customerdetails` (`id`, `name`, `email`, `password`, `gender`, `mobile`, `aadhar`, `address`, `registrationdate`, `tokens`, `amount`, `file`, `username`) VALUES
(3, 'Ritik Sarathe ', 'ritiksarathe@gmail.com', 'e6450a21cef5e3a1b0aa3681fe4eae6f', 'Male', 2147483647, 999988882, 'Hoshangabad', '2022-10-11', 120, 4500, 'images/Mess.jpg', 'ritik'),
...
(1, 'Ritik Sarathe', 2147483647, 'Food is good');
